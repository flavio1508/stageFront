...
const ProjectStatus = () => {
  ...
  useEffect(() => {
    axios.get(`https://stagebackend-1.onrender.com/api/projects/${projectId}`)
      .then(response => {
  ...
  const handleStatusChange = (key) => {
    ...
    axios.put(`https://stagebackend-1.onrender.com/api/projects/${projectId}/status`, {status: updatedStatus})
      .then(response => {
