...
const ProjectsSimple = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://stagebackend-1.onrender.com/api/users/me', {withCredentials: true})
      .then(response => {
        ...
        return axios.get(`https://stagebackend-1.onrender.com/api/projects?email=${response.data.email}`, {withCredentials: true});
      })
      .then(response => {
  ...
  const handleSaveProject = () => {
    ...
    if (newProject.name && newProject.startDate) {
      ...
      axios.post('https://stagebackend-1.onrender.com/api/projects', newProjectObj, {withCredentials: true})
        .then(response => {
  ...
  const handleDeleteProject = (id) => {
    ...
    axios.delete(`https://stagebackend-1.onrender.com/api/projects/${id}`, {withCredentials: true})
      .then(() => {
